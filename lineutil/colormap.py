_colors = {
    ...
    "contrast1": [
        "#000000", "#e21919", "#00008c", "#39ac58", "#dfa920", "#ac39ac", "#c65353",
    ],
    "contrast2": [
        "#000000", "#fa3e00", "#16169c", "#009900", "#e69900", "#a824a8", "#c65139",
    ],
    "office": [
        "#000000", "#156082", "#E97132", "#196B24", "#0F9ED5", "#A02B93", "#4EA72E"
    ],
    "office+": [
        "#000000", "#4D93D9", "#F1A983", "#47D359", "#61CBF3", "#D86DCD", "#8ED973",
    ],
    "neon": [
        "#666666", "#1d67c9", "#f0027f", "#2fbeda", "#8e59c0", "#ec79c9", "#e62a19",
    ],
    "accent1": [
        "#000000", "#ec13a0", "#00cc70", "#3d68f5", "#ec5151",
    ],
    "pair" :[
